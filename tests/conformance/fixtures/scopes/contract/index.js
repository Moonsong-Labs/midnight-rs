...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      readTwice: async (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`readTwice: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('readTwice',
                                     'argument 1 (as invoked from Typescript)',
                                     'scopes.compact line 14 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const result_0 = await this._readTwice_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        __compactRuntime.finalizeCallProofData(context, partialProofData);
        return { result: result_0, context: context, gasCost: context.callContext.currentGasCost };
      }
    };
    this.impureCircuits = { readTwice: this.circuits.readTwice };
    this.provableCircuits = { readTwice: this.circuits.readTwice };
  }
  async initialState(...args_0) {
    ...
    state_0.setOperation('readTwice', new __compactRuntime.ContractOperation());
  ...
  async _readTwice_0(context, partialProofData) {
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
