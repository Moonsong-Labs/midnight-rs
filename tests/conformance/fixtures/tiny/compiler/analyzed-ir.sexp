(analyzed-ir (compiler-version "0.33.122") (language-version "0.25.107")
  ...
  (exports (clear . %clear.17) (get . %get.18)
    ...
    (value . %value.14))
  (contract-types)
  (kernel-declaration (%kernel.35 () (exported #f) (Kernel)))
  (public-ledger-declaration
    ...
    (constructor
      ((%v.38 (tfield (field-native))))
      (seq (let* (((%sk.36 (tbytes 32)) (call
                                          %private$secret_key.19)))
             (seq (let* (((%tmp.37 (tbytes 32)) (call
                                                  %public_key.15
                                                  (var-ref %sk.36))))
                    (public-ledger %authority.23 write (0) write (ttuple)
                      (instructions
                        (push
                          (storage #f)
                        ...
                        (ins (cached #f) (n 1)))
                      (var-ref %tmp.37)))
                  (public-ledger %value.14 write (1) write (ttuple)
                    (instructions
                      (push
                        (storage #f)
                      ...
                      (push
                        (storage #t)
                        (value (state-value cell (var-ref %v.38))))
                      (ins (cached #f) (n 1)))
                    (var-ref %v.38))
                  (public-ledger %state.21 write (2) write (ttuple)
                    (instructions
                      (push
                        (storage #f)
  ...
  (circuit %set.16 (exported #t) (pure #f) (proof #t)
    ((%v.30 (tfield (field-native)))) (ttuple)
    (seq (seq (assert
                (call
                  %in_state.25
                  (enum-ref (tenum STATE unset set) unset))
                "set: attempted to overwrite recorded value")
              (let* (((%sk.28 (tbytes 32)) (call %private$secret_key.19)))
                (let* (((%apk.29 (tbytes 32)) (call
                                                %public_key.15
                                                (var-ref %sk.28))))
                  (seq (public-ledger %authority.23 write (0) write (ttuple)
                         (instructions
                           (push
                             (storage #f)
                             (value (state-value cell (align 0 1))))
                           (push
                             (storage #t)
                             (value (state-value cell (var-ref %apk.29))))
                           (ins (cached #f) (n 1)))
                         (var-ref %apk.29))
                       (public-ledger %value.14 write (1) write (ttuple)
                         (instructions
                           ...
                           (push
                             (storage #t)
                             (value (state-value cell (var-ref %v.30))))
                           (ins (cached #f) (n 1)))
                         (var-ref %v.30))
                       (public-ledger %state.21 write (2) write (ttuple)
                         (instructions
  ...
  (circuit %get.18 (exported #t) (pure #f) (proof #t) ()
    ...
    (return
      (if (call
          ...
          (call
            %some.31
            (public-ledger %value.14 read (1) read (tfield (field-native))
              (instructions
                (dup (n 0))
  ...
  (circuit %clear.17 (exported #t) (pure #f) (proof #t) () (ttuple)
    (seq (seq (assert
              ...
              (let* (((%sk.20 (tbytes 32)) (call %private$secret_key.19)))
                (let* (((%apk.22 (tbytes 32)) (call
                                                %public_key.15
                                                (var-ref %sk.20))))
                  (seq (assert
                         (== (tbytes 32)
                             (var-ref %apk.22)
                             (public-ledger %authority.23 read (0) read (tbytes 32)
                               (instructions
                                 (dup (n 0))
                                 (idx (cached #f)
                                      (pushPath #f)
