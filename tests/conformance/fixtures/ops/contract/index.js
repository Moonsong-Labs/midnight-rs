...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      field_arith: async (...args_1) => {
        ...
        const result_0 = await this._field_arith_0(context,
                                                   partialProofData,
                                                   a_0,
                                                   b_0);
      ...
      field_reduce: async (...args_1) => {
        ...
        const result_0 = await this._field_reduce_0(context,
                                                    partialProofData,
                                                    c_0,
                                                    q_0);
        partialProofData.output = { value: _descriptor_2.toValue(result_0), alignment: _descriptor_2.alignment() };
      ...
      transient_hashes: async (...args_1) => {
        ...
        const result_0 = await this._transient_hashes_0(context,
                                                        partialProofData,
                                                        x_0,
                                                        r_0);
        partialProofData.output = { value: _descriptor_2.toValue(result_0), alignment: _descriptor_2.alignment() };
      ...
      persistent_hashes: async (...args_1) => {
        if (args_1.length !== 2) {
        ...
        const result_0 = await this._persistent_hashes_0(context,
                                                         partialProofData,
                                                         x_0);
      ...
      transient_conversions: async (...args_1) => {
        if (args_1.length !== 2) {
        ...
        const result_0 = await this._transient_conversions_0(context,
                                                             partialProofData,
                                                             x_0);
        partialProofData.output = { value: _descriptor_2.toValue(result_0), alignment: _descriptor_2.alignment() };
        __compactRuntime.finalizeCallProofData(context, partialProofData);
      ...
      curve_ops: async (...args_1) => {
        ...
        const result_0 = await this._curve_ops_0(context,
                                                 partialProofData,
                                                 s_0,
                                                 m_0);
        partialProofData.output = { value: _descriptor_2.toValue(result_0), alignment: _descriptor_2.alignment() };
      ...
      ledger_ops: async (...args_1) => {
        ...
        const result_0 = await this._ledger_ops_0(context,
                                                  partialProofData,
                                                  k_0,
                                                  v_0,
                                                  entry_0);
      ...
      casts: async (...args_1) => {
        ...
        const result_0 = await this._casts_0(context, partialProofData, n_0, f_0);
        partialProofData.output = { value: _descriptor_0.toValue(result_0), alignment: _descriptor_0.alignment() };
        __compactRuntime.finalizeCallProofData(context, partialProofData);
        return { result: result_0, context: context, gasCost: context.callContext.currentGasCost };
      }
  ...
  _hashToCurve_0(value_0) {
    const result_0 = __compactRuntime.hashToCurve(_descriptor_8, value_0);
    return result_0;
  }
  async _field_arith_0(context, partialProofData, a_0, b_0) {
  ...
  async _field_reduce_0(context, partialProofData, c_0, q_0) {
  ...
  async _transient_hashes_0(context, partialProofData, x_0, r_0) {
  ...
  async _persistent_hashes_0(context, partialProofData, x_0) {
  ...
  async _transient_conversions_0(context, partialProofData, x_0) {
  ...
  async _curve_ops_0(context, partialProofData, s_0, m_0) {
  ...
  async _ledger_ops_0(context, partialProofData, k_0, v_0, entry_0) {
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
  ...
  async _casts_0(context, partialProofData, n_0, f_0) {
    const wide_0 = n_0 + 1n;
    const as_field_0 = wide_0;
    const b_0 = __compactRuntime.convertBigintToBytes(32,
