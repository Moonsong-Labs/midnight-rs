...
//!
//! Re-exports [`midnight_base_crypto`], [`midnight_curves`], and
//! [`midnight_transient_crypto`] as namespaced modules so downstream
//! consumers (e.g. validator implementations that need
//! `PersistentHashWriter`, `JubjubSubgroup`, `EmbeddedGroupAffine`,
...
pub use midnight_curves as curves;
