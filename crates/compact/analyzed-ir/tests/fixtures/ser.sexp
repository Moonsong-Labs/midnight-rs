(analyzed-ir (compiler-version "0.33.122") (language-version "0.25.107")
  ...
  (circuit %serialize.18 (exported #f) (pure #t) (proof #f)
    ((%value.19
       (tstruct P (a (tunsigned 65535)) (b (tboolean)))))
    (tbytes 8)
    (return
  ...
  (circuit %store.10 (exported #t) (pure #f) (proof #t)
    ((%x.15 (tunsigned 65535)) (%f.16 (tboolean))) (ttuple)
    (seq (let* (((%tmp.17 (tbytes 8)) (call
                                        %serialize.18
                                        (new (tstruct
                                               P
                                               (a (tunsigned 65535))
                                             ...
                                             (var-ref %x.15)
                                             (var-ref %f.16)))))
           (public-ledger %cell.11 (0) write (ttuple)
             (instructions
               (push (storage #f) (value (state-value cell (align 0 1))))
               (push
                 (storage #t)
                 (value (state-value cell (var-ref %tmp.17))))
               (ins (cached #f) (n 1)))
             (var-ref %tmp.17)))
         (return (tuple))))
  (circuit %load.12 (exported #t) (pure #f) (proof #t) ()
    ...
    (return
      (call
        %deserialize.13
        (public-ledger %cell.11 (0) read (tbytes 8)
          (instructions
            (dup (n 0))
