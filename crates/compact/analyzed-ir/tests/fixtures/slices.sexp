(analyzed-ir (compiler-version "0.33.122") (language-version "0.25.107")
  ...
  (public-ledger-declaration
    ...
    (constructor () (tuple)))
  (circuit %pack3.57 (exported #f) (pure #t) (proof #f)
    ...
    (let* (((%packed.73 (tunsigned 65535)) (+ (tunsigned 65535)
                                              ...
                                              (safe-cast
                                                ...
                                                (bytes-ref
                                                  ...
                                                  (var-ref %b.72)
                                                  '5)))))
      (seq (public-ledger %byte_pair.47 write (0) write (ttuple)
             (instructions
  ...
  (circuit %slice_bytes_const.45 (exported #t) (pure #f) (proof #t)
    ...
    (let* (((%tail.67 (tbytes 4)) (bytes-slice
                                    ...
                                    '3
                                    4)))
      (seq (public-ledger %tail_bytes.39 write (3) write (ttuple)
             (instructions
  ...
  (circuit %slice_vector_const.41 (exported #t) (pure #f) (proof #t)
    ...
    (let* (((%mid.64 (tvector 3 (tfield (field-native)))) (tuple-slice
      ...
      (let* (((%packed.65 (tfield (field-native))) (call
                                                     %pack3.57
                                                     (var-ref %mid.64))))
        (seq (public-ledger %vector_digest.38 write (1) write (ttuple)
               (instructions
      ...
      (let* (((%mid.53
        ...
        (let* (((%packed.54 (tfield (field-native))) (+ (tfield
                                                        ...
                                                        (tuple-ref
                                                          (var-ref %mid.53)
                                                          1))))
          (seq (public-ledger %tuple_digest.40 write (2) write (ttuple)
                 (instructions
                   (push
                     (storage #f)
  ...
  (circuit %slice_vector_dynamic.42 (exported #t) (pure #f) (proof #t)
    ...
    (let* (((%start.56 (tunsigned 1)) '1))
      (let* (((%mid.58 (tvector 3 (tfield (field-native)))) (vector-slice
                                                              (tvector
                                                                6
                                                                (tfield
                                                                  (field-native)))
                                                              ...
                                                              (var-ref
                                                                %start.56)
                                                              3)))
        (let* (((%packed.59 (tfield (field-native))) (call
                                                       %pack3.57
                                                       (var-ref %mid.58))))
          (seq (public-ledger %vector_digest.38 write (1) write (ttuple)
                 (instructions
