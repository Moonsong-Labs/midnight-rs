...
pub fn try_builtin_typed(
    ...
    match name {
        ...
        "transientHash" => {
            ...
            use midnight_types::transient_crypto::repr::FieldRepr;
        ...
        "degradeToTransient" => {
            ...
            use midnight_types::transient_crypto::hash::degrade_to_transient;
...
mod tests {
    ...
    fn commit_builtins_bind_to_the_typed_struct_encoding() {
        ...
        let expected = midnight_types::transient_crypto::hash::transient_commit(
