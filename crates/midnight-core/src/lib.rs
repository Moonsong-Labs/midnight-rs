...
/// Generate typed Rust bindings from a Compact `normalized-ir.sexp` file.
///
...
/// midnight_core::contract!(Gateway, "gateway-normalized-ir.sexp");
///
/// // Flat output (struct named `Ledger`).
/// midnight_core::contract!("gateway-normalized-ir.sexp");
/// ```
#[cfg(feature = "contract")]
#[macro_export]
