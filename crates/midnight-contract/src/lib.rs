...
pub use midnight_wallet::{Wallet, WalletState};
...
pub use call::{
    ...
    build_context_from_state, call_funded, call_funded_with, deploy_funded, deploy_local,
    deserialize_state, fetch_state, fetch_state_at, fetch_state_from_node, format_address,
    parse_address, submit, wait_for_contract_update, wait_for_deployment, with_zk_keys,
};
