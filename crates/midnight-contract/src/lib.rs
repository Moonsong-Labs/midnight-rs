...
pub use call::{CircuitDefs, ExternalShieldedInputs, ShieldedInputs};
...
// and the other-wallet snapshot for `with_shielded_inputs_from`.
pub use midnight_wallet::{ShieldedInputSource, SpendableShieldedCoin};
