...
pub struct ShieldedInputs {
    ...
    /// [`SpendableShieldedCoin`](midnight_wallet_core::SpendableShieldedCoin).
    ///
    ...
    pub coins: Vec<midnight_wallet_core::SpendableShieldedCoin>,
}
...
fn ensure_shielded_inputs_spendable(
    requested: &[midnight_wallet_core::SpendableShieldedCoin],
    owned: &[midnight_wallet_core::SpendableShieldedCoin],
...
mod tests {
    ...
    fn spendable_coin(nullifier_byte: u8) -> midnight_wallet_core::SpendableShieldedCoin {
        midnight_wallet_core::SpendableShieldedCoin {
            token_type: tt(0),
            value: 1,
            nonce: [0u8; 32],
